...
#
usage() {
  echo -e "\n$SCRIPT_NAME [-s true/false] [-w true/false] [-t /path/to/src.tgz]"
...
echo -e "##### Wipe Enabled: $wipe"
echo -e "##### Source tgz to install: $src_tgz"
...
# Stage hadoop source
#
$SCRIPTS_DIR/build/stage_hadoop_source_from_tgz.sh -t $src_tgz

#
# Build hadoop
#
$SCRIPTS_DIR/build/build_hadoop.sh || exit 1
