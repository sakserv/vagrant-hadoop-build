...
#
usage() {
  echo -e "\n$SCRIPT_NAME [-s true/false] [-w true/false] [-t /path/to/binary.tgz]"
...
echo -e "##### Source tgz to install: $bin_tgz"
...
# Install Hadoop
#
$SCRIPTS_DIR/bootstrap/install_hadoop_from_binary_release.sh -t $bin_tgz
